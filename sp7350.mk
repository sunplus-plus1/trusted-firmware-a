...
CONFIG_GLB_GMNCFG_MODEL_TFA_CFG = "sp7350"
ECHO = echo
MAKE_JOBS = -j 30 -l 24
...
#	@$(PRJ_SHOWBUILDMESG)
	...
	$(MAKE) ${MAKE_JOBS} $(PRJ_EXT_PARA) -C $(PRJ_BUILD_ROOT) \
		BUILD_STRING=$(shell git rev-parse --short HEAD 2> /dev/null) CROSS_COMPILE=$(CROSS) PLAT=$(CONFIG_GLB_GMNCFG_MODEL_TFA_CFG) SPD=opteed DEBUG=0 LOG_LEVEL=40 \
...
distclean clean:
	@$(MAKE) ${MAKE_JOBS} $(PRJ_EXT_PARA) -C $(PRJ_BUILD_ROOT) \
		CROSS_COMPILE=$(CROSS) PLAT=sp7350 DEBUG=0 $@
	@$(RM) -f $(PRJ_OUTPUT_FILE)
#	@$(PRJ_CHKCLEANRESULT)
